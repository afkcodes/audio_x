...
export declare class BaseStreamController
  extends TaskLoop
  implements NetworkComponentAPI
{
  protected hls: Hls;
  ...
  protected _handleFragmentLoadComplete(
...
export declare type DRMSystemsConfiguration = Partial<
...
export declare type ElementaryStreams = Record<
...
export declare enum ErrorActionFlags {
  None = 0,
...
declare type FragmentLoadProgressCallback = (
...
export declare type FragParsingInitSegmentData = {};
...
export declare interface HlsProgressivePerformanceTiming
  extends HlsPerformanceTiming {
  first: number;
}
...
declare type ILogFunction = (message?: any, ...optionalParams: any[]) => void;
...
export declare type LoaderOnAbort<T extends LoaderContext> = (
  stats: LoaderStats,
  context: T,
  networkDetails: any
) => void;

export declare type LoaderOnError<T extends LoaderContext> = (
  error: {
    code: number;
    text: string;
  },
...
export declare type LoaderOnProgress<T extends LoaderContext> = (
  stats: LoaderStats,
  context: T,
...
export declare type LoaderOnSuccess<T extends LoaderContext> = (
  response: LoaderResponse,
  stats: LoaderStats,
  context: T,
  networkDetails: any
...
export declare type LoaderOnTimeout<T extends LoaderContext> = (
  stats: LoaderStats,
  context: T,
  networkDetails: any
) => void;
...
export declare type MediaKeyFunc = (
...
export declare enum NetworkErrorAction {
  DoNothing = 0,
  SendEndCallback = 1,
...
declare type SourceBuffers = Partial<
...
export declare class SubtitleStreamController
  extends BaseStreamController
  implements NetworkComponentAPI
{
